...
<section class="hero-section_inner">
    <img class="img-fluid" src="images/bespoke-banner.png" alt="him banner">

    <div class="hero_content_inner">
        <h2 class="main_head mb-4">Bespoke Wedding Hampers</h2>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="collection_box">
                    <img class="img-fluid mb-4" src="images/bespoke1.png" alt="images">
            ...
            <div class="col-md-4">
                <div class="collection_box">
                    <img class="img-fluid mb-4" src="images/bespoke2.png" alt="images">
                    <h3 class="sub_head">For Her — The Desert Rose</h3>
                    <p>Objects for hosting, memory, and grace</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="collection_box">
                    <img class="img-fluid mb-4" src="images/bespoke3.png" alt="images">
                    <h3 class="sub_head">For Her — The Desert Rose</h3>
                    <p>Objects for hosting, memory, and grace</p>
                </div>
            </div>
...
<section class="mt_80">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="collection_box">
                    <img class="img-fluid mb-4" src="images/bespoke4.png" alt="images">
                    <h3 class="sub_head">For Her — The Desert Rose</h3>
                    <p>Objects for hosting, memory, and grace</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="collection_box">
                    <img class="img-fluid mb-4" src="images/bespoke5.png" alt="images">
                    <h3 class="sub_head">For Her — The Desert Rose</h3>
                    <p>Objects for hosting, memory, and grace</p>
                </div>
            </div>
